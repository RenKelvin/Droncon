...
- (void)onSocket:(AsyncSocket *)sock didReadData:(NSData *)data withTag:(long)tag
{
    ...
    {
        NSLog(@"READ_TAG_HTTP_HEADERS: %lu bytes", (unsigned long)[data length]);
    ...
    {
        NSLog(@"READ_TAG_SOI: %lu bytes", (unsigned long)[data length]);
        [imgBuffer appendData:data];
    ...
    {
        NSLog(@"image: %lu bytes", (unsigned long)[data length]);
        [imgBuffer appendData:data];
